...
@section('title', content: 'Nasabah Menunggak')
@section('content')

    <div class="card rounded-0">
        <div class="card-header">
            <h2 class="h4 mb-0">Data Nasabah Menunggak</h2>
        </div>
        <div class="card-body">
        </div>
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-end">Nominal Tunggakan</th>
            ...
            <tbody>
                @foreach ($data as $index => $row)
                    @php
                        ...
                        $month = 0;
                        $amount = 0;
                        foreach ($row->repayments as $key => $payment) {
                            if ($payment->status == 'pending' && $payment->due_date < $dateNow) {
                                $month++;
                    ...
                    <tr>
                        ...
                        <td class="text-center"> {{ $month }} Bulan </td>
